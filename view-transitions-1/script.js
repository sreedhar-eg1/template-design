document.addEventListener("DOMContentLoaded", () => {
  ...
  grid.addEventListener("click", async (e) => {
    ...
    // to animate the view transition psuedo element, i.e view-transition-root,...
...
/*
If we want to apply view transition via javascript, then we need to animate it on document.documentElement
And inside animate method, we need to pass psuedoElement property with view transition name, i.e ::view-transition-new(root)
